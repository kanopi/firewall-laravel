...
final class ChallengeTest extends TestCase
{
    ...
    public function the_submission_still_reaches_the_firewall_without_global_middleware(): void
    {
        ...
        $interstitial = $this->app->make(\Kanopi\Firewall\Laravel\Http\FirewallResponder::class)
            ->challenge(
                \Illuminate\Http\Request::create('/gated'),
                new \Kanopi\Firewall\Exception\ChallengeRequiredException('Challenge required')
            );
